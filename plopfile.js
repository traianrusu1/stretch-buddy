    ...
    actions: [
      {
        ...
        path: 'src/components/{{where}}/{{pascalCase name}}/{{pascalCase name}}.tsx',
        templateFile: 'plop-templates/Component/Component.tsx.template',
      },
      {
        type: 'add',
        path: 'src/components/{{where}}/{{pascalCase name}}/{{pascalCase name}}.test.tsx',
        templateFile: 'plop-templates/Component/Component.test.tsx.template',
      },
      {
        type: 'add',
        path: 'src/components/{{where}}/{{pascalCase name}}/{{pascalCase name}}.module.scss',
